        ...
        <div className="user-page">
            <div className="user-page__info" style={{ height: '90%', width: '60vw'}}>
                ...
                <p>
                    ...
                    <Input fullWidth type="text" disabled={true} readOnly={true} value={1} />
                </p>
                ...
                <div style={{ margin: '1.5rem 0 1rem 0', width:'100%',display: 'flex' , justifyContent: 'space-evenly'}}>
                    <Button onClick={(goBack)=>navigateTo(-1)}>Cancelar</Button>
                    <Button variant="contained" onClick={handleCheckBooking}>Confirmar reserva</Button>
                </div>
            </div>
            {showModal && (
                <Dialog open={showModal} onClose={handleCloseModal}>
                    ...
                    <div className="calification" style={{ fontWeight: "600", paddingTop: '1rem' }}>
                        <p style={{ fontWeight: "600" }}>¿Estás seguro/a de que deseas realizar la reserva?</p>
                    </div>
                    <DialogActions style={{ justifyContent: 'center', marginBottom: '1rem' }} >
                        <Button onClick={handleEditBooking} >Editar Datos</Button>
                        <Button variant="contained" onClick={handleConfirmBooking} >Confirmar reserva</Button>
                    </DialogActions>
                </Dialog>
            )}
            {showModalConfirm && (
                <Dialog open={showModal} onClose={handleCloseModal}>
                    ...
                    <DialogActions style={{ justifyContent: 'center', marginBottom: '1rem' }} >
                        <Button variant="contained" onClick={handleNavigate} >OK</Button>
                    </DialogActions>
                </Dialog>
            )}
        </div>
